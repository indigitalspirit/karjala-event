                              ...
                              <div class="we-know-slider__wrapper">
                                ...
                                ?>
                                  <div class="we-know-slider__item">
                                    <img 
                                        src="<?php echo $cb_service__slider__item;?>"
                                        class="attachment-full size-full" alt="<?php echo $cb_service__slider__item;?>">
                                  </div>
                                <?php 
                                    endif;
                                  }
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-12">
                      <div class="vc_column-inner">
                        ...
                        <a href="<?php echo $cb_blog__btn_link ?>"
                          ...
                          <span
                            class="mkdf-btn-text"><?php echo $cb_blog__btn_text; ?>
                          </span> 
                          <svg version="1.1"
