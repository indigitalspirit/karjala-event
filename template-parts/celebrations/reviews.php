...
if( $args['page_id'] ):
  ...
  $cb_reviews__title = get_field("cb-reviews__title", $args['page_id']);
  $cb_reviews = get_field("cb-reviews", $args['page_id']);
                            ...
                            <div class="reviews-slider__item">
                              <div class="reviews-slider__img">
                                <img src="<?php echo $item_img["url"]; ?>" class="attachment-full size-full image__animation-tranform"
                                  alt="<?php echo $item_img["alt"]; ?>" class=" image__animation-tranform">
                              </div>
