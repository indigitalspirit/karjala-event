...
if( $args['page_id'] ):
  ...
  $cb_blog__title = get_field("cb-blog__title", $args['page_id']);
  $cb_blog__item_slug_1 = get_field("cb-blog__item-slug_1", $args['page_id']);
  $cb_blog__item_slug_2 = get_field("cb-blog__item-slug_2", $args['page_id']);
  $cb_blog__item_slug_3 = get_field("cb-blog__item-slug_3", $args['page_id']);
  $cb_blog__btn_text = get_field("cb-blog__btn-text", $args['page_id']);
  $cb_blog__btn_link = get_field("cb-blog__btn-link", $args['page_id']);
            ...
            <div
              ...
              <div class="mkdf-bl-wrapper mkdf-outer-space">
                <ul class="mkdf-blog-list">
                  ...
                  <?php if( $cb_blog__item_slug_2 ): 
                      $args = array(
                        'name'        => $cb_blog__item_slug_2,
                        'post_type'   => 'post',
                        'post_status' => 'publish',
                        'numberposts' => 1
                      );
                  ...
                  <?php if( $cb_blog__item_slug_3 ): 
                      $args = array(
                        'name'        => $cb_blog__item_slug_3,
                        'post_type'   => 'post',
                        'post_status' => 'publish',
                        'numberposts' => 1
                      );
