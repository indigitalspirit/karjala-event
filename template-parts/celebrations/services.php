...
if( $args['page_id'] ):
  ...
  $cb_service__title = get_field("cb-service__title", $args['page_id'] );
  $cb_service__text = get_field("cb-service__text", $args['page_id'] );
  $cb_service__slider = get_field("cb-service__slider", $args['page_id'] );
                  ...
                  <div class="we-know-slider">
                    <?php 
                      foreach( $cb_service__slider as $cb_service__slider__item ) {
                        ...
                        if( $cb_service__slider__item["url"] ):
                      
                      
                    ?>
                    <div class="we-know-slider__item">
                      <img src="<?php echo $cb_service__slider__item["url"];?>" class="attachment-full size-full image__animation-tranform"
                        alt="<?php echo $cb_service__slider__item["alt"];?>">
                    </div>
                    <?php 
                        endif;
                      }
