...
if( $args['page_id'] ):
  ...
  $tr_blog__title = get_field("tr-blog__title", $args['page_id']);
  $tr_blog__item_slug_1 = get_field("tr-blog__item-slug_1", $args['page_id']);
  $tr_blog__item_slug_2 = get_field("tr-blog__item-slug_2", $args['page_id']);
  $tr_blog__item_slug_3 = get_field("tr-blog__item-slug_3", $args['page_id']);
  $tr_blog__btn_text = get_field("tr-blog__btn-text", $args['page_id']);
  $tr_blog__btn_link = get_field("tr-blog__btn-link", $args['page_id']);
