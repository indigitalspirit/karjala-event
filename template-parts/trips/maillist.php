...
if( $args['page_id'] ):
  ...
  $tr_mailform__img = get_field("tr-mailform__img", $args['page_id'] );
  $tr_mailform__title = get_field("tr-mailform__title", $args['page_id'] );
  $tr_mailform__descr = get_field("tr-mailform__descr", $args['page_id'] );
  $tr_mailform__shortcode = get_field("tr-mailform__shortcode", $args['page_id'] );
  $tr_mailform__descr_2 = get_field("tr-mailform__descr_2", $args['page_id'] );
  $tr_mailform__btn_text = get_field("tr-mailform_btn-text", $args['page_id'] );
  $tr_mailform__btn_link = get_field("tr-mailform_btn-link", $args['page_id'] );
                      ...
                      <div class="mkdf-eh-item-content mkdf-eh-custom-6959">
                        <div class="mkdf-single-image-holder">
                          <div class="mkdf-si-inner">
                            <img src="<?php echo $tr_mailform__img["url"]; ?>"
                              alt="<?php echo $tr_mailform__img["alt"]; ?>" class=" image__animation-tranform"> </div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="mkdf-eh-item-inner">
                      <div class="mkdf-eh-item-content mkdf-eh-custom-3422">
                        ...
                        <div class="trips-page__block_maillist-text-bottom">
                          ...
                          <a href="<?php echo $tr_mailform__btn_link; ?>"
                            ...
                            <span class="mkdf-btn-text">
                              ...
                              <?php echo $tr_mailform__btn_text; ?>
                            </span>
                          </a>
