            ...
            <div class="widget_text widget widget_custom_html">
              <div class="textwidget custom-html-widget">
                <!-- <a href="index.html"> <img
                    ...
                    alt="alt" style="max-width: 144px;" /></a> -->
          ...
          <nav class="mkdf-fullscreen-menu">
            <ul id="menu-full-screen-menu" class="">
              <li id="popup-menu-item-728"
                ...
                <a href="#" class=" current "><span>Homepages</span><i
          ...
          <div class="mkdf-full-width-inner main-page__full-width-inner">
            <div class="mkdf-grid-row">
              <div class="mkdf-page-content-holder mkdf-grid-col-12">
                ...
                <!-- <div class="vc_row wpb_row vc_row-fluid vc_custom_1576679106364 vc_row-has-fill main-page__row"> -->
                                              ...
                                              <div class="mkdf-position-left">
                                                <div class="main-page__header-row">
                                                  ...
                                                  <div class="main-page__header-phone">
                                                    <a class="mkdf-icon-widget-holder green-hover" href="tel:+123%2045677%20789"
                                                      target="_blank">
                                                ...
                                                <div class="main-page__header-row">
                                                  <!-- <nav class="mkdf-main-menu mkdf-drop-down mkdf-default-nav">
                                                    <ul class="main-page__header-menu">
                                                      <li>
                                                        <a class="mkdf-link-with-svg" href="pohodi.html">
                                                          <span>
                                                            ...
                                                            <span class="mkdf-link-with-svg-text">Походы</span>
                                                          </span>
                                                        </a>
                                                      </li>
                                                      <li>
                                                        <a class="mkdf-link-with-svg" href="korporativy.html">
                                                          <span>
                                                            <span class="mkdf-active-hover">
                                                              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                                                y="0px" viewBox="0 0 15.7 30" style="enable-background:new 0 0 15.7 30;" xml:space="preserve"
                                                            ...
                                                            <span class="mkdf-link-with-svg-text">Корпоративы</span>
                                                          </span>
                                                        </a>
                                                      </li>
                                                      <li>
                                                        <a class="mkdf-link-with-svg" href="svadby.html">
                                                          <span>
                                                            <span class="mkdf-active-hover">
                                                              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                                                y="0px" viewBox="0 0 15.7 30" style="enable-background:new 0 0 15.7 30;" xml:space="preserve"
                                                            ...
                                                            <span class="mkdf-link-with-svg-text">
                                                              Свадьбы
                                                            </span>
                                                          </span>
                                                        </a>
                                                      ...
                                                      <li>
                                                        <a class="mkdf-link-with-svg" href="prazdniki.html">
                                                          <span>
                                                            <span class="mkdf-active-hover">
                                                              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                                                y="0px" viewBox="0 0 15.7 30" style="enable-background:new 0 0 15.7 30;" xml:space="preserve"
